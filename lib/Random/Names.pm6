...
my constant %info =
  ...
  cerf => [
    "Vinton Gray Cerf - American Internet pioneer, recognised as one of \"the fathers of the Internet\". With Robert Elliot Kahn, he designed TCP and IP, the primary data communication protocols of the Internet and other computer networks.",
  ...
  conway => [
    "Damian Conway (born 5 October 1964 in Melbourne, Australia) is a computer scientist, a member of the Perl and Raku communities, a public speaker, and the author of several books.",
  ...
  curran => [
    "Samuel Curran is the inventor of the scintillation counter, the proportional counter, and the proximity fuze.",
  ...
  keldysh => [
    "Mstislav Keldysh - a Soviet scientist in the field of mathematics and mechanics, academician of the USSR Academy of Sciences (1946), President of the USSR Academy of Sciences (1961â€“1975), three times Hero of Socialist Labor (1956, 1961, 1971), fellow of the Royal Society of Edinburgh (1968).",
  ...
  lumiere => [
    "Auguste and Louis LumiÃ¨re - the first filmmakers in history.",
  ...
  merkle => [
    "Ralph C. Merkle - American computer scientist, known for devising Merkle's puzzles - one of the very first schemes for public-key cryptography. Also, inventor of Merkle trees and co-inventor of the Merkle-DamgÃ¥rd construction for building collision-resistant cryptographic hash functions and the Merkle-Hellman knapsack cryptosystem.",
  ...
  nash => [
    "John Forbes Nash, Jr. - American mathematician who made fundamental contributions to game theory, differential geometry, and the study of partial differential equations.",
  ...
  northcutt => [
    ...
    "https://www.businessinsider.com/poppy-northcutt-helped-apollo-astronauts-2014-12?op=1"
  ],
  noyce => [
  ...
  poincare => [
    "Henri PoincarÃ© made fundamental contributions in several fields of mathematics.",
  ...
  tereshkova => [
    "Valentina Tereshkova is a Russian engineer, cosmonaut and politician. She was the first woman to fly to space in 1963. In 2013, at the age of 76, she offered to go on a one-way mission to Mars.",
  ...
  tu => [
    "Youyou Tu - Chinese pharmaceutical chemist and educator known for discovering artemisinin and dihydroartemisinin, used to treat malaria, which has saved millions of lives. Joint winner of the 2015 Nobel Prize in Physiology or Medicine.",
  ...
  wall => [
    "Larry Wall is the inventor of the Perl and Raku programming languages and various basic open source tools such as 'patch'.",
  ...
  worthington => [
    "Jonathan Worthington - architect and main developer of MoarVM, a virtual machine to run Raku.",
    "https://6guts.wordpress.com/2013/05/31/moarvm-a-virtual-machine-for-nqp-and-rakudo/"
  ],
  wozniak => [
